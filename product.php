      ...
      <div class="row">
        <div class="col-md-6">
          <div class="aspect-ratio-container aspect-ratio-16-9">
            <img src="<?php echo $row['foto'] ?>" alt="" class="aspect-ratio-content img-fluid" style="border-radius: 22px;">
          </div>
        </div>
        <div class="col-md-6">
          <div class="descriptionContainer">
            ...
            <form method="post">
              ...
              <div class="d-flex justify-content-start mt-4">
                <button type="submit" class="btn btn-primary send-form">Agregar al carrito</button>
            </form>
            <?php
            if ($_POST) {
              ...
              $port = 3306;
              $conn = new mysqli($host, $user, $password, $db, $port);
              $sql = "INSERT INTO carrito (id_producto, cantidad) VALUES ('$id', '$cantidad')";
              $result = $conn->query($sql);

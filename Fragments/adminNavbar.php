<nav class="navbar navbar-expand-lg border-bottom">
  <div class="container-fluid">
    ...
    <a href="../../pages/admin/adminPage.php" class="navbar-brand">
      <img src="../../images/logo.png" alt="" id="logo" height="33px" width="47px">
    </a>
    <a class="navbar-brand" href="../../pages/admin/adminPage.php">MascoTienda - Administración</a>
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 flex-grow-1">
        <li class="nav-item mx-4">
          <a class="nav-link" aria-current="page" href="../../pages/admin/adminPage.php">Gestion de productos</a>
        </li>
      </ul>
